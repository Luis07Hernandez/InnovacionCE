...
<head>
    ...
    <title>InnovaciónCE - Inicio</title>
    <!--Estilos locales-->
    <link href="../assets/css/indexUser.css" rel="stylesheet">
...
<body>
    ...
    <section class="banner">
        ...
        <div class="header-1">
            <h2 style="color:white;">¡No te preocupes por el financiamiento si no lo necesitas. Hoy es más económico que nunca iniciar un negocio!</h2>
            <p></p>
            <a id="CrearProyecto" href="misproyectos.php" class="btn btn-warning">¡Crear Proyecto!</a><!--Link a Mis Proyectos-->
        </div>
    ...
    <section class="footer">
        <div class="container">
            <div class="text-center" style="padding-top: 80px; padding-bottom: 80px;"> <!--Centramos el texto con la clase text-center de bootstrap y con estilos de damos padding top y bot-->
                <h1 class="text-center" style="color: white;">¿Quieres comenzar a crear un proyecto?</h1>
                <a href="#" class="btn btn-warning">¡Si quiero!</a> <!--BOTON PARA MANDAR A MIS PROYECTOS-->
            </div>
...
<!--SCRIPTS-->
    ...
    <script src="../assets/js/indexUser.js"></script>
